...
const HistoriaClinica = () => {
    ...
    console.log(id, "este es el id de ")
    console.log(idUsuario, "este es el id del usuario")
    console.log(idHistoria, "este es el id de la hisotria")

    const isAdmin = User.currentUser && User.currentUser.email === 'admin@gmail.com';

    const getHistoriaClinica = async () => {
        const querySnapshot = await getDocs(collection(db, `/Clientes/${idUsuario}/Mascotas/${id}/HistoriaClinica/${idHistoria}`));
        console.log(querySnapshot,"qs devuelve")
